...
const ShippingStep = () => {
  ...
  return (
    <View className="flex-1 p-4">
      ...
      <Section title="Shipping options" titleSize="lg" className="mb-4 mt-8" />
      <Selectable
    ...
    <View className="flex-1 p-4">
      ...
      {paymentMethods.map((method) => (
        <Selectable
          ...
          customIcon={
            <Fontisto
              name={method.type === "visa" ? "visa" : "mastercard"}
              size={22}
              color="black"
            />
          }
    ...
    <ScrollView className="flex-1">
      ...
      <View className="px-global border-light-secondary dark:border-dark-darker border-b-4 pb-7">
        ...
        <View className="">
          <View className="mb-4 flex-row items-center">
            <Image
              source={require("@/assets/img/male-2.jpg")}
            ...
            <View className="ml-4 flex-1">
              ...
              <ThemedText className="mt-1 font-bold">$49.99</ThemedText>
            </View>
          </View>
          <View className="flex-row items-center">
            <Image
              source={require("@/assets/img/female-2.jpg")}
              className="h-28 w-20 rounded-lg"
            />
            <View className="ml-4 flex-1">
              ...
              <ThemedText className="mt-1 font-bold">$59.99</ThemedText>
            </View>
          </View>
        </View>
      </View>
      ...
      <View className="px-global border-light-secondary dark:border-dark-darker border-b-4 py-7">
        ...
        <View className=" rounded-lg">
          ...
          <View className="bg-light-border dark:bg-dark-border my-2 h-[1px]" />
...
const CheckoutScreen = () => {
  ...
  useEffect(() => {
    if (currentStep < 2) {
      // Show for shipping and payment steps (0 and 1)
      actionSheetRef.current?.show(0);
    } else {
      // Hide for review step (2)
      ...
      <View className="px-global mb-4 w-full flex-row items-center justify-between">
        ...
        <View className="flex-row items-center">
          ...
          >
            <Image
              source={require("@/assets/img/female-2.jpg")}
              className="-mr-4 h-24 w-16 -rotate-6 rounded-xl"
            />
          </AnimatedView>
          <AnimatedView
            animation="zoomInRotate"
